...
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Olá! Gostaria de saber mais sobre os vossos produtos.")}`;
      ...
      <div className="max-w-[1400px] mx-auto flex items-end justify-between">
        ...
        >
          <motion.div
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 px-5 py-3.5 rounded-full bg-green-500 text-white font-bold text-sm shadow-2xl shadow-green-500/30 hover:bg-green-600 transition-colors"
          >
